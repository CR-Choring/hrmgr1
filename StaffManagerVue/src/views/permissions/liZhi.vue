<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-input v-model="clerkQueryVo.position" placeholder="职工职位" />
      </el-form-item>
      <el-form-item>
        <el-input
      ...
      <el-button
        ...
        > 查询</el-button
      >
      <el-button type="default"  style="font-size: 16px;" @click="resetData()"> 清空</el-button>
    </el-form>
    <el-table
      :data="list"
    ...
    >
      ...
      <el-table-column prop="name" sortable label="职工姓名" width="100" />
